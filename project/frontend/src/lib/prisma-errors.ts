...
export class PrismaQueryParameterLimitExceededError extends BaseError {
  code = "P2029";
}
...
export class PrismaDatabaseAssertionViolationError extends BaseError {
  code = "P2035";
}
export class PrismaExternalConnectorError extends BaseError {
  code = "P2036";
}
export class PrismaTooManyConnectionsError extends BaseError {
  code = "P2037";
}
...
export class PrismaInvalidExternalTableConfigurationError extends BaseError {
  code = "P3023";
}
export class PrismaInvalidExternalTableSimpleConfigurationError extends BaseError {
  code = "P3024";
}
...
export class PrismaAccelerateServerError extends BaseError {
  code = "P6000";
}
export class PrismaAccelerateInvalidDataSourceError extends BaseError {
  code = "P6001";
}
export class PrismaAccelerateUnauthorizedError extends BaseError {
  code = "P6002";
}
export class PrismaAcceleratePlanLimitReachedError extends BaseError {
  code = "P6003";
}
export class PrismaAccelerateQueryTimeoutError extends BaseError {
  code = "P6004";
}
export class PrismaAccelerateInvalidParametersError extends BaseError {
  code = "P6005";
}
export class PrismaAccelerateVersionNotSupportedError extends BaseError {
  code = "P6006";
}
export class PrismaAccelerateEngineStartError extends BaseError {
  code = "P6008";
}
export class PrismaAccelerateResponseSizeLimitExceededError extends BaseError {
  code = "P6009";
}
export class PrismaAccelerateProjectDisabledError extends BaseError {
  code = "P6010";
}
...
const errorCodeToClass = {
  ...
  P2029: PrismaQueryParameterLimitExceededError,
  ...
  P2035: PrismaDatabaseAssertionViolationError,
  P2036: PrismaExternalConnectorError,
  P2037: PrismaTooManyConnectionsError,
  ...
  P3023: PrismaInvalidExternalTableConfigurationError,
  P3024: PrismaInvalidExternalTableSimpleConfigurationError,
  ...
  // P6xxx (Accelerate)
  P6000: PrismaAccelerateServerError,
  P6001: PrismaAccelerateInvalidDataSourceError,
  P6002: PrismaAccelerateUnauthorizedError,
  P6003: PrismaAcceleratePlanLimitReachedError,
  P6004: PrismaAccelerateQueryTimeoutError,
  P6005: PrismaAccelerateInvalidParametersError,
  P6006: PrismaAccelerateVersionNotSupportedError,
  P6008: PrismaAccelerateEngineStartError,
  P6009: PrismaAccelerateResponseSizeLimitExceededError,
  P6010: PrismaAccelerateProjectDisabledError,
} as const;

type ErrorCode = keyof typeof errorCodeToClass;

export function toTypedPrismaError(error: unknown) {
